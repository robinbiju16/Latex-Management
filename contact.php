  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-12-12">
        		<table cellpadding="20" width="100%" style="text-align:left" >
					<tr><td width="40%">
					<div class="" style="padding-left: 50px;" >
                        <div class="">
                            <h3 tkey="">Send us your feedback</h3>
                            
								<form id="" action="mail.php" method="post">
                                <div class="">
                                    <div class="">
                                       <div class="" id="" tkey="enter_name">Please enter name.</div>
                                    ...
                                    <div class="">
                                        <div class="" id="err-email" tkey="enter_email">Please enter valid email adress.</div>
                                        <input class="" type="email" name="email" id="email" placeholder="* Your email...">
                                ...
                                <div class="">
                                    <div class="">
                                        ...
                                        <div class="" id="err-comment" tkey="enter_comment">Please enter your comment.</div>
                                         <textarea class="" name="comment" id="comment" placeholder="* Comments..."></textarea>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="">
                                        <div class="" data-sitekey=""></div>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="">
                                        <button id="send-mail" class="" tkey="">Send message</button>
                                        <!--<h6 style="text-align:center;color:red;" tkey="feedback_unavailable"></h6>--></div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="col-md-6" style="padding-left:50px;">
                        <div class="" style="">
                            <p class="" tkey="rrii_expansion">Palakkaran 005 Latex Dealers</p>
                            <p class="" tkey="rrii_address">pala P.O.,<br>Kottayam,<br>Kerala, India<br>PIN : 686009<br>Ph : +91 481 2354423</p>
                            <hr>
                                                   </div>
                    </div>
					</td>
