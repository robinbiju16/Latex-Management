...
">
  <form action="" class="form-container" method="post" >
    ...
    <input type="text" value=<?php $d=date('Y-m-d'); echo"$d"; ?> name="dat" disabled required>
    
    <label for="tp"><b>Number of Tins purchase</b></label>
    <input type="text" placeholder="Enter Number of tins to purchase" pattern="[0-9]{}" name="tp" required>

    <label for="td"><b>Number of Tins you want</b></label>
    <input type="text" placeholder="Number of Tins you want" pattern="[0-9]{}" name="td" >
   ...
   <?php 
	...
	if(isset($_POST["submit"]))
	{
		...
		$sql1="select * from inform where mob='$mob'";
		$res1=mysqli_query($con,$sql1);
		if(mysqli_num_rows($res1)>0)
		{
			echo "<script>alert('You are already registered ');history.go(-2);</script>";
		}
	else{
	
		  $sql="insert into inform (mob,tinp,tinw,dat) values ('$mob','$tp','$td','$d')"; 
