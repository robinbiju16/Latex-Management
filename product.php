  ...
  <div class="content">
	 ...
	 while($r=mysqli_fetch_array($res))
	{
		...
		echo"+</li>
              ...
              <a href='#' onclick=openForm() class='button blue gradient wide cropSides cropBottom ae-7'>PURCHASE IT</a>
            </li>
            </div>";
	}
		 ?> 
	 ...
	 while($r=mysqli_fetch_array($res))
	{
		...
		echo"+</li>
		 ...
		 ?> 
          ...
          <h1 class="ae-1">Rubber Plants</h1>
          <?php 
	require("db.php");
...
">
  <form action="action_page.php" method="post" class="form-container" >
	...
	<a href="for.php" style="color:dodgerblue;font-size: 15px" >forgot password</a>
