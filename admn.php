...
<li><a href="admnorder.php">Orders</a></li>
 ...
 <li><a href="mypro.php">My Profile</a></li>
 </ul>
    </div>
    <div class="right"><a class="button blue gradient" id="lgobtn" onclick="" href="index.php">Logout</a></div>
  </div>
  <div class="sections compact hidden">
    <div class="left"><a href="#" title="Slides Framework"><svg style="width:82px;height:24px"><!-- <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use>--> <h1><a href="index.html">PalakkaraN 005</a></h1></svg></a></div>
