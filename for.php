    ...
    <div class="container">
      <div class="wrap">
       ...
       <form action="" method="post">
        <center>
         <table>
			 <tr><td height="45"> <label for="mob"><b>Mob</b></label></td>
 <td> <input type="text" placeholder="Enter Mobile number" pattern="[0-9]{10}" name="mob" required><br></td></tr>
      	<tr><td height="41"><label for="perad"><b>Permanent Address</b></label></td>
 
     	 <td> <textarea name="perad" required></textarea> <br></td></tr>
      	<tr><td height="35"><label for="email"><b>Email</b></label></td>
 <td> <input type="text" placeholder="Enter email" name="email" required><br></td></tr>
      	</table>
       	<br>
       <button name="submit" type="submit" class="signupbtn">Submit</button>
       </center>
		  </form>
<?php if(isset($_POST["submit"])){
	extract($_POST);
	 require("db.php");
	 $sql="select * from user where mob='$mob'"; 
	...
	if($r['Paddr']==$perad)
	{
		if($r['email']==$email)
		{
			 $sql1="select * from login where mob='$mob'"; 
	 $res1=mysqli_query($con,$sql) or die(mysqli_error($con));
	$r1=mysqli_fetch_array($res);
	$comment=$r1['password'];
	$from="palakkaran005@gmail.com";
		if(mail($email,$from,$comment))
		{
