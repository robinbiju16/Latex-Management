        ...
        <div class="fix-12-12">
          <ul class="grid">
            <li class="col-6-12 left">
              <h1 class="ae-2 fromLeft">Services</h1>
              <p class="ae-3 fromLeft"><span class="opacity-8">“A lot of companies have chosen to downsize, and maybe that was the right thing for them. We chose a different path. Our belief was that if we kept putting great products in front of customers, they would continue to open their wallets.” –Steve Jobs</span></p>
              <ul class="tabs controller uppercase bold ae-4 fromCenter" data-slider-id="60-1">
                <li class="selected">Latex Collection</li>
                <li>Fertilizers</li>
                <li>Equipments</li>
                <li>Rubber plants</li>
              </ul>
            ...
            <li class="col-6-12 left ae-5 fromCenter">
              <ul class="slider animated margin-top-4" data-slider-id="60-1">
                <li class="selected fromCenter">
                  <div  data-popup-id="60-1">
                    <img class="wide" src="assets/img/gallery-60-1.jpg" />
                  </div>
                </li>
                <li class="fromCenter">
                  <div  data-popup-id="60-2">
                    <img class="wide" src="assets/img/gallery-60-2.jpg" />
                  </div>
                </li>
                <li class="fromCenter">
                  <div data-popup-id="60-3">
                    <img class="wide" src="assets/img/gallery-60-3.jpg"/>
                  </div>
                </li>
				<li class="fromCenter">
                  <div  data-popup-id="60-4">
                    <img class="wide" src="assets/img/gallery-60-4.png"/>
                  </div>
                </li>
              </ul>
            </li>
