        ...
        <div class="fix-12-12">
          <ul class="flex fixedSpaces verticalCenter reverse">
            <li class="col-6-12 left middle">
              <h1 class="ae-1 fromLeft">Palakkaran 005</h1>
              <p class="ae-2 fromLeft"><span class="opacity-8">Kerala's No 1 Latex Collection Dealers provide Best price for the latex and all the support to the planters.</span></p>
              <a class="button blue gradient" id="chkbtn" onclick="openForm1()" href="#">Check Price</a>
			
			  <a class="button red gradient  ae-3 fromCenter cropLeft" href="registration.php">New Registration/OTP verification</a>
            </li>
            <li class="col-6-12">
              <img class="ae-4" width="605" src="assets/img/iphones-34.gif" alt="iPhones Thumbnail" data-action="zoom"/>
            </li>
          </ul>
        </div>
...
<div class="form-popup" id="rubrate">
<div style="margin-top:100px; background-color: white;">
  <form action="actionp.php" class="form-container" >
    <h1>Today's Price</h1>
...
<td>
    ...
    <label for="r4"><b>RSS4 Rate</b></label></td>
   <td> <input type="text" value=<?php echo $r['rss4']?> name="r4" disabled></td></tr>
<tr>
<td>
    <label for="r3"><b>RSS3 Rate</b></label></td>
   <td> <input type="text" value=<?php echo $r['rss3']?> name="r3" disabled></td></tr>
<tr>
<td>
    <label for="r2"><b>RSS2 Rate</b></label></td>
   <td> <input type="text" value=<?php echo $r['rss2']?> name="r2" disabled></td></tr>
<tr>
<td>
    <label for="lr"><b>Latex Rate</b></label></td>
   <td> <input type="text" value=<?php echo $r['latex']?> name="lr" disabled></td></tr>
...
<script>
function openForm1() {
document.getElementById("rubrate").style.display = "block";
}

function closeForm1() {
  document.getElementById("rubrate").style.display = "none";
}
</script>
