...
<section class="slide fade-6 kenBurns" data-name="">
  <div class="content">
	...
	require("db.php");
			 $sql1="delete from product where stock='0'";
		   $res1=mysqli_query($con,$sql1);
	 $sql="select * from product where pdtcode like'FR%'"; 
	 $res=mysqli_query($con,$sql) or die(mysqli_error($con));
			if(mysqli_num_rows($res)>0)
			{
				echo"<h1 class='ae-1'>Fertilizer</h1> ";
			
	 while($r=mysqli_fetch_array($res))
	{
		echo"<div class='fix-10-12'>";
          echo"<ul class='grid grid-83 noSpaces equal ae-2 fadeIn' style='background: #F5FBFE'>";
           echo"<li class='grid grid-83 noSpaces equal ae-2 fadeIn'>";
             echo"<h3>";
		echo $r['name'];
		echo"</h3>
              <div class='price ae-5'><span class='currency'>INR</span>";
		echo $r['price'];
		echo"</div>
              <div class='ae-5'>
                <h6 class='uppercase bold small opacity-4'>Product Code:    ";
		echo $r['pdtcode'];
		echo"</h6>
              </div>
              <div class='margin-top-3 margin-bottom-3 equalElement ae-6'>
                <ul class='p tiny'>
                  <li><strong>
		Manufacture:"; echo $r['mfatur'];
		echo"</strong></li>
                  <li class='opacity-7'>Available Stock:";
		echo $r['stock'];
		echo"</li>
                  <li class='opacity-7'>Free Delivary charge</li>
                </ul>
              </div>
              <a href='payment.php?pcod=".$r['pdtcode']."' class='button blue gradient wide cropSides cropBottom ae-7'>";
	 ...
	 $sql="select * from product where pdtcode like'EQ%'"; 
	 $res=mysqli_query($con,$sql) or die(mysqli_error($con));
			if(mysqli_num_rows($res)>0)
			{
				echo"<h1 class='ae-1'>Equipments</h1>";
	 while($r=mysqli_fetch_array($res))
	{
		echo"<div class='fix-10-12'>";
          echo"<ul class='grid grid-83 noSpaces equal ae-2 fadeIn' style='background: #F5FBFE'>";
	 ...
	 $sql="select * from product where pdtcode like'RB%'"; 
	 $res=mysqli_query($con,$sql) or die(mysqli_error($con));
			if(mysqli_num_rows($res)>0)
			{
				 echo" <h1 class='ae-1'>Rubber Plants</h1>";
	 while($r=mysqli_fetch_array($res))
	{
		echo"<div class='fix-10-12'>";
          echo"<ul class='grid grid-83 noSpaces equal ae-2 fadeIn' style='background: #F5FBFE'>";
